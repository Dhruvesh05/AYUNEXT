  ...
  return (
    <div className="homepage">
      ...
      <section className="hero" id="hero">
        <header>
          <div className="logo"><img src="/Ayunextlogo.png" alt="Ayunext Logo" /></div>
                ...
                <li className="dropdown" ref={dropdownRef}>
                  ...
                  {dropdownOpen && (
                    <div className="dropdown-menu">
                      <button className="dropdown-item" onClick={() => handleServiceClick(0)}>Software Development</button>
                      <button className="dropdown-item" onClick={() => handleServiceClick(1)}>Digital Marketing</button>
                      <button className="dropdown-item" onClick={() => handleServiceClick(2)}>Financial Services</button>
                    </div>
                  )}
                </li>
        ...
        <div className="hero-container">
          <div className="hero-content">
            <div className="hero-text">
              <h1 className="hero-title">Innovation.<br />Finance. Growth</h1>
              <p className="hero-description">
                Ayunext Solutions delivers business-focused technology and financial services to help companies grow,
                streamline operations, and secure their financial future.
              </p>
              <button className="cta-button">Get Advice</button>
            </div>

            <div className="hero-stats">
              <div className="stat-item"><div className="stat-number">50+</div><div className="stat-label">Clients served</div></div>
              <div className="stat-item"><div className="stat-number">100+</div><div className="stat-label">Successful Projects</div></div>
              <div className="stat-item"><div className="stat-number">95%</div><div className="stat-label">Positive Feedback</div></div>
            </div>
          </div>
      ...
      {/* Services Section with activeServiceTab prop */}
